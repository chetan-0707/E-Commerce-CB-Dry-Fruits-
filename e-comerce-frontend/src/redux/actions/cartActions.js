...
export const addToCart = (id, qty, itemName) => async dispatch => {
  console.log("Item_name...",id ,itemName, `/api/${itemName}/${id}`)
  const {data} = await Api.getRequest(`/api/${itemName}/${id}`)
  console.log("data....", data)

  // const product = typeof data === "object"?JSON.parse(data)
